...
try:
    ...
    sm.logger.info("mpd beim Runterfahren nicht mehr erreichbar")

sm.lg = 'D '
while True:
    name = input('Sound message "D " festlegen: ')
    if name == 'next':
        break
    else:
        sm.play_sound_msg(name)

sm.lg = 'GB'
while True:
    name = input('Sound message "GB" festlegen: ')
    if name == 'next':
        break
    else:
        sm.play_sound_msg(name)
...
sm.lg = 'Cz'
while True:
    name = input('Sound message "Cz" festlegen: ')
    if name == 'next':
        break
    else:
        sm.play_sound_msg(name)
