...
Modifizierte Variante, damit nicht ewig auf eine Karte gewartet wird, sondern nur kurz geschaut,
ob eine da ist, und wenn ja, dann auslesen. Dauer damit immer noch 0.11s.
"""
...
class Pn532_i2c:
    ...
    def read_mifare(self):
        """If there is a MIFARE-card in the PN532's field, read it's UID."""
